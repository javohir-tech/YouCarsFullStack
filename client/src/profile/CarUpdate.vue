    ...
    <div class="add-car-page">
        <div class="container">
            ...
            <div class="form-section">
                <a-select v-model:value="formData.marka" placeholder="Марка" size="large" show-search
                    :loading="loadingBrands" :disabled="!selectedType" @change="handleMarkaChange"
                    :filter-option="filterOption" :status="validationErrors.marka ? 'error' : ''">
            ...
            <div v-if="formData.car_model" class="main-form">
                        ...
                        <a-row :gutter="16">
                            ...
                            <a-col :span="12">
                                <a-form-item label="Год выпуска" :validate-status="validationErrors.year ? 'error' : ''"
                                    ...
                                    <a-input-number v-model:value="formData.year" placeholder="2024" style="width: 100%"
                                        size="large" @blur="validateField('year')" />
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="Страна" :validate-status="validationErrors.country ? 'error' : ''"
                                    ...
                                    <a-select v-model:value="formData.country" placeholder="США" size="large"
                                        show-search :loading="loadingCountries" :filter-option="filterOption"
                            ...
                            <a-col :span="12">
                                <a-form-item label="Топливо" :validate-status="validationErrors.fuel ? 'error' : ''"
                                    ...
                                    <a-select v-model:value="formData.fuel" placeholder="Бензин" size="large"
                                        :loading="loadingFuels" @change="validateField('fuel')">
                            ...
                            <a-col :span="12">
                                <a-form-item label="Объем"
                                    :validate-status="validationErrors.displacement ? 'error' : ''"
                            ...
                            <a-col :span="12">
                                <a-form-item label="Мощность" :validate-status="validationErrors.power ? 'error' : ''"
                                    ...
                                    <a-input-number v-model:value="formData.power" placeholder="153" style="width: 100%"
                                        size="large" @blur="validateField('power')">
                            ...
                            <a-col :span="12">
                                <a-form-item label="Привод"
                                    :validate-status="validationErrors.drive_type ? 'error' : ''"
                            ...
                            <a-col :span="12">
                                <a-form-item label="КПП"
                                    :validate-status="validationErrors.transmission_type ? 'error' : ''"
                                    :help="validationErrors.transmission_type">
                                    <a-select v-model:value="formData.transmission_type" placeholder="Автомат"
                                        size="large" @change="validateField('transmission_type')">
                            ...
                            <a-col :span="12">
                                <a-form-item label="Количество дверей"
                                    :validate-status="validationErrors.doors_count ? 'error' : ''"
                            ...
                            <a-col :span="12">
                                <a-form-item label="Состояние"
                                    :validate-status="validationErrors.condition ? 'error' : ''"
                            ...
                            <a-col :span="12">
                                <a-form-item label="Цвет" :validate-status="validationErrors.color ? 'error' : ''"
                                    ...
                                    <a-select v-model:value="formData.color" placeholder="Белый" size="large"
                                        :loading="loadingColors" @change="validateField('color')">
                        ...
                        <div class="uploaded-images">
                            <div v-for="(image, index) in uploadedImages" :key="index" class="image-item">
                                ...
                                <div class="image-overlay">
                                    <a-button type="text" danger @click="removeImage(index)"
                ...
                <div class="description-section">
                    <h2>Описание</h2>
                    <p class="section-subtitle">Не указывайте ссылки на источники, цены, контакты и не предлагайте
                        другие услуги!
                ...
                <div class="price-section">
                    <h2>Цена</h2>
                    <a-form-item :validate-status="validationErrors.price ? 'error' : ''"
                        :help="validationErrors.price">
                        <a-input-number v-model:value="formData.price" placeholder="1 850 000" size="large"
                            style="width: 100%" @blur="validateField('price')">
                            <template #addonAfter>
...
<script setup>
import { ref, reactive, computed, h, onMounted, toRaw } from 'vue';
...
const getDataCar = async () => {
    try {
        ...
        uploadedImages.value = data.images.map((item, index) => {
            return { url: item.image }
        })
        console.log(toRaw(uploadedImages.value))
        handleModelChange()
